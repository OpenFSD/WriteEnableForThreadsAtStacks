...
namespace Avril_FSD
{
    unsigned char coreId_For_WritePraise_Index = NULL;
    ...
    WriteEnable_STACK_Control::WriteEnable_STACK_Control(
    ...
    void WriteEnable_STACK_Control::WriteEnable_Activate(
    ...
    void WriteEnable_STACK_Control::WriteEnable_SortQue(
        class Avril_FSD::WriteEnable_STACK_Global* global
    )
    {
        for (unsigned char index_A = 0; index_A < (global->Get_NumCores() - 1); index_A++)
        {
            for (unsigned char index_B = (index_A + 1); index_B < global->Get_NumCores(); index_B++)
            {
    ...
    void WriteEnable_STACK_Control::WriteEnable_Request(
        unsigned char coreId,
        class Avril_FSD::WriteEnable_STACK_Global* global
    )
    {
        ...
        else
        {
            ...
            if (Get_new_coreIdForWritePraiseIndex() == global->Get_NumCores())
            {
    ...
    void WriteEnable_STACK_Control::WriteQue_Update(class Avril_FSD::WriteEnable_STACK_Global* global)
    {
        for (unsigned char index = 0; index < global->Get_NumCores(); index++)
        {
    ...
    unsigned char WriteEnable_STACK_Control::Get_coreIdForWritePraiseIndex()
    {
        return coreId_For_WritePraise_Index;
    }
    int WriteEnable_STACK_Control::Get_count_WriteActive(unsigned char coreId)
    {
        return ptr_count_CoreId_WriteActive[coreId];
    }
    int WriteEnable_STACK_Control::Get_count_WriteIdle(unsigned char coreId)
    {
        return ptr_count_CoreId_WriteIdle[coreId];
    }
    int WriteEnable_STACK_Control::Get_count_WriteWait(unsigned char coreId)
    {
        return ptr_count_CoreId_WriteWait[coreId];
    }
    unsigned char WriteEnable_STACK_Control::GetFlag_CoreId_WriteEnable()
    {
        return ptr_que_CoreToWrite[0];
    }
    unsigned char WriteEnable_STACK_Control::Get_new_coreIdForWritePraiseIndex()
    {
        return ptr_new_coreId_For_WritePraise_Index;
    }
    unsigned char WriteEnable_STACK_Control::Get_que_CoreToWrite(unsigned char index)
    {
        return ptr_que_CoreToWrite[index];
    }

    void WriteEnable_STACK_Control::Set_count_WriteActive(unsigned char coreId, int value)
    {
        ptr_count_CoreId_WriteActive[coreId] = value;
    }
    void WriteEnable_STACK_Control::Set_count_WriteIdle(unsigned char coreId, int value)
    {
        ptr_count_CoreId_WriteIdle[coreId] = value;
    }
    void WriteEnable_STACK_Control::Set_count_WriteWait(unsigned char coreId, int value)
    {
        ptr_count_CoreId_WriteWait[coreId] = value;
    }
    void WriteEnable_STACK_Control::SetFlag_readWrite_Open(bool value)
    {
        praisingWrite = value;
    }
    void WriteEnable_STACK_Control::SetFlag_writeState(unsigned char coreId, unsigned char index, bool value)
    {
        flag_WriteState[coreId][index] = value;
    }
    void WriteEnable_STACK_Control::Set_new_coreIdForWritePraiseIndex(unsigned char value)
    {
        ptr_new_coreId_For_WritePraise_Index = value;
    }
    void WriteEnable_STACK_Control::Set_que_CoreToWrite(unsigned char index, unsigned char value)
    {
        ptr_que_CoreToWrite[index] = value;
    }

    void WriteEnable_STACK_Control::DynamicStagger(
        unsigned char coreId
    )
    {
        if (Get_coreIdForWritePraiseIndex() == coreId)
    ...
    void WriteEnable_STACK_Control::WriteEnable_ShiftQueValues(
    ...
    bool WriteEnable_STACK_Control::GetFlag_readWrite_Open()
    {
        return praisingWrite;
    }

    bool WriteEnable_STACK_Control::GetFlag_writeState(unsigned char coreId, unsigned char index)
    {
        return flag_WriteState[coreId][index];
    }

    void WriteEnable_STACK_Control::Set_coreIdForWritePraiseIndex(unsigned char value)
    {
